package com.artilugios.Artilugios.Security;


import com.artilugios.Artilugios.Security.Service.UserDetailsImpl;
import com.artilugios.Artilugios.Security.jwt.JwtEntryPoint;
import com.artilugios.Artilugios.Security.jwt.JwtTokenFilter;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
 ...
 @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        List<String> list2 = Arrays.asList(new String[]{"https://artilugioscn23.web.app"});
